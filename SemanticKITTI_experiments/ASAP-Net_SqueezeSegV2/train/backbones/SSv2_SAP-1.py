...
class Backbone(nn.Module):
  ...
  def __init__(self, params):
    ...
    self.fuse_layer1 = nn.Conv1d(768, 384, kernel_size=1, stride=1)
  ...
  def forward(self, x):
    ...
    for frame_idx in range(frame_num):
        ...
        if frame_idx == 0:
          cur_xyz_l1, cur_feat_l1, sampled_feat_l1 = self.tem_sa1(cur_xyz_l0.contiguous(), cur_feat_l0.contiguous())
          center_xyz_l1 = cur_xyz_l1
          pre_feat_l1 = cur_feat_l1
        else:
          ...
          cur_xyz_l1, cur_feat_l1, _ = self.tem_sa1(expand_xyz_l0, expand_feat_l0, center_xyz_l1)

          fuse_feat_l1 = torch.cat([pre_feat_l1, cur_feat_l1], dim=1)
          fuse_feat_l1 = self.tem_dropout(fuse_feat_l1)

          cur_feat_l1 = self.fuse_layer1(fuse_feat_l1)
          pre_feat_l1 = cur_feat_l1
