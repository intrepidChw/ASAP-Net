...
from tasks.semantic.modules.vis_user import *


if __name__ == '__main__':
  parser = argparse.ArgumentParser("./vis_infer.py")
  parser.add_argument(
      '--dataset', '-d',
      type=str,
      required=True,
  ...
  parser.add_argument(
    ...
    type=str,
    required=True,
    help='predictions root. No Default',
  )
  parser.add_argument(
      '--log', '-l',
      type=str,
  ...
  try:
    ...
    seq_dir = os.path.join(FLAGS.log, "sequences")
  ...
  user = User(ARCH, DATA, FLAGS.dataset, FLAGS.prediction, FLAGS.log, FLAGS.model)
  user.infer()
