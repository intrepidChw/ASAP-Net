...
// __global__ void query_ball_point_gpu(int b, int n, int m, float radius, int nsample, 
//     const float *__restrict__ xyz, const float *__restrict__ new_xyz, int *__restrict__ idx, int *pts_cnt) {
//     // new_xyz: (B, M, 3)
//     // xyz: (B, N, 3)
//     // output:
//     //      idx: (B, M, nsample)
