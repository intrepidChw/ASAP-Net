...
def pointnet_sa_module(xyz, points, new_xyz, npoint, radius, nsample, mlp, mlp2, group_all, is_training, bn_decay, scope, bn=True, pooling='max', knn=False, use_xyz=True, use_nchw=False):
    ...
    with tf.variable_scope(scope, reuse=tf.compat.v1.AUTO_REUSE) as sc:
        ...
        if group_all:
            ...
            new_xyz, new_points, idx, sample_idx, grouped_xyz = sample_and_group(npoint, radius, nsample, xyz, points, new_xyz, knn, use_xyz)
